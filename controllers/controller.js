...
router.get('/scrape', function (req, res) {
    ...
    request('https://twitter.com/search?q=world+cup+news&ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Esearch', function (error, response, html) {
        ...
        $('article .inner').each(function (i, element) {
            ...
            result.link = 'https://twitter.com/search?q=world+cup+news&ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Esearch' + $(this).children('header').children('h2').children('a').attr('href').trim();
            ...
            if (result.title !== "" && result.summary !== "") {
                ...
                // BUT we must also check within each scrape since twitter has duplicate articles...
                ...
                // Log that scrape is working, just the content was missing parts
                    ...
                    console.log('Redundant twitter Content. Not Saved to DB.')
                }
